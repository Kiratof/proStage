 ...
 */
final class Version20191220080544 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE stage ADD entreprise_id INT NOT NULL, ADD stage VARCHAR(255) NOT NULL, DROP entreprise');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE stage ADD entreprise VARCHAR(25) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, DROP entreprise_id, DROP stage');
    }
}
